...
const Aside = (properties) => {
  const { setView, view } = properties
        ...
        <div className="p-0">
          <Link
            ...
            className={classCondition(
              ...
              view === 'shifts' ? 'bg-red-200 text-red-900 border-0' : 'hover:bg-red-50'
            )}
          ...
          <Link
            ...
            className={classCondition(
              'flex items-center font-bold text-sm py-3 px-4 w-full outline-none ',
              view === 'customers' ? 'bg-red-200 text-red-900 border-0' : 'hover:bg-red-50'
            )}
          ...
          <Link
            ...
            className={classCondition(
              'flex items-center font-bold text-sm py-3 px-4 w-full outline-none ',
              view === 'new-customer' ? 'bg-red-200 text-red-900 border-0' : 'hover:bg-red-50'
            )}
