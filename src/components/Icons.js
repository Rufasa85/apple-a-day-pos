const Icons = {
  Cake: (properties) => {
    const { className = 'w-6 h-6' } = properties
    return (
  ...
  Date: (properties) => {
    const { className = 'w-6 h-6' } = properties
    return (
      <svg fill="none" viewBox="0 0 24 24" strokeWidth="1.8" className={className}>
        <path
          strokeLinecap="round"
  ...
  Plus: (properties) => {
    const { className = 'w-6 h-6' } = properties
    return (
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="3 3 18 18" strokeWidth={1.5} stroke="currentColor" className={className}>
