...
const Card = (properties) => {
  const { customer, setCustomer } = properties
  ...
  return (
    <button
      ...
      className="p-5 bg-white ring-inset ring-1 ring-gray-200 shadow shadow-gray-200 cursor-pointer h-20 gap-3 rounded-2xl w-full flex relative"
      type="button"
    >
