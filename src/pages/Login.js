  ...
  return (
    <main className="flex flex-col justify-center items-center w-full h-screen border-2 bg-gray-500 bg-opacity-50">
      <form
        ...
        className="gap-6 px-24 py-10 relative flex flex-col justify-center items-center shadow-2xl border border-slate-300 bg-slate-100 rounded-lg"
      >
        <BouncingApple />
