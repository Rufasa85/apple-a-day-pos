      ...
      <div className="flex items-center space-x-4">
        ...
        <div className="flex-1 min-w-0">
          ...
          <p className="text-sm text-gray-500 truncate flex">
            ...
            {customerObj.dateOfBirth ? dayjs(customerObj.dateOfBirth, 'YYYY-MM-DD').format('MMM DD, YYYY') : '--'}
          </p>
        </div>
        <div className="inline-flex items-center text-base font-semibold text-gray-900">Orders: {customerObj.Orders.length}</div>
      </div>
    </Link>
  </li>
)
